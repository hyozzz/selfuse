...
installbbr(){
	...
	if [[ "${release}" == "centos" ]]; then
		...
		if [[ ${bit} = "x86_64" || ${bit} = "aarch64" ]]; then
			...
			detele_kernel_head
			headurl="https://github.com/hyozzz/selfuse/raw/main/kernel/linux-headers-5.14.9_5.14.9-1_amd64.deb"
			imgurl="https://github.com/hyozzz/selfuse/raw/main/kernel/linux-image-5.14.9_5.14.9-1_amd64.deb"
